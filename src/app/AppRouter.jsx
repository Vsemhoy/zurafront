...
export function AppRouter() {
  ...
  return <Routes><Route path="/login" element={<LoginPage/>}/><Route element={<AuthenticatedApp/>}><Route index element={<DashboardPage/>}/><Route path="tasks" element={<TaskerPage/>}/><Route path="tasks/:taskId" element={<TaskerPage/>}/><Route path="tasks/:taskId/edit" element={<TaskEditorPage/>}/><Route path="planner" element={<PlannerPage/>}/><Route path="projects" element={<ProjectorPage/>}/><Route path="contractors" element={<ContractorPage/>}/><Route path="kpi" element={<KpiPage/>}/><Route path="factor" element={<FactorPage/>}/><Route path="events" element={<EventorPage/>}/><Route path="books" element={<BookerPage/>}/><Route path="books/:bookId" element={<BookerPage/>}/><Route path="books/:bookId/pages/:pageId" element={<BookerPage/>}/><Route path="books/:bookId/pages/:pageId/versions/:pageVersionId" element={<BookerPage/>}/><Route path="books/:bookId/pages/:pageId/blocks/:blockId" element={<BookerPage/>}/><Route path="books/:bookId/pages/:pageId/blocks/:blockId/versions/:versionId" element={<BookerPage/>}/></Route><Route path="*" element={<Navigate to="/" replace/>}/></Routes>;
}
