...
function UnscheduledTray({ tasks, onDragStart, onDragEnd, onOpen }) {
...
export function PlannerPage() {
    ...
    return <main className={`planner-page ${bulkOpen ? 'planner-page--bulk' : ''}`}>
        ...
        <section className="planner-workspace">
            ...
            {queueOpen && <UnscheduledTray tasks={calendar.data?.unscheduled ?? []} onDragStart={setDragItem} onDragEnd={() => setDragItem(null)} onOpen={(task) => navigate(`/tasks/${task.id}/edit`)}/>}
