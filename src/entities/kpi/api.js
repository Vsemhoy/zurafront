...
export const kpiApi = {
    ...
    async stats(scopeId, month, userId = null) { const query = new URLSearchParams({ month }); if (userId) query.set('user_id', userId); return (await apiRequest(`/scopes/${scopeId}/kpis/stats?${query}`)).data; },
